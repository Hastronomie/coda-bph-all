...
$villageois= new Character("Villageois", 10);
$warrior= new Warrior(9999999, "Petit-pied", 99999999);
$mage= new Mage(1, "Sorcier suprême", 1);

echo "-{$warrior->introduce($warrior->GetName())}<br>";
echo "-Trop bien, tu dois être nouveau ! Moi c'est {$mage->introduce($mage->GetName())}<br>";
echo "-Tandis que moi je suis un simple {$villageois->GetName()}. Montrez-moi votre puissance !<br>";
